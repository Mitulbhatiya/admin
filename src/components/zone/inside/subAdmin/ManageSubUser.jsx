...
const ManageSubUser = () => {
    ...
    adminReducer.users?.map((value, index) => {
        if (id == value.zone && value.role === "zonesubadmin") {
    ...
    return (
        <>
            <p>Sub-admins count : {subAdmin_count}</p>
            ...
            <div className="d-flex justify-content-end">
                {
                    adminReducer.post_role_user_progress === true
                        ...
                        : <button className='btn btn-md btn-outline-danger' onClick={() => onSubmitSubUser()}>Sub-user to User</button>
                }
            </div>
